...
async function Signup() {
  ...
  let Response = await fetch("https://api.weathersystem.org/signup", {
    method: "POST",
    headers: {
...
async function signin() {
  ...
  let Response = await fetch("https://api.weathersystem.org/login", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
...
async function VerifyServer(Username, Token) {
  ...
  let Response = await fetch("https://api.weathersystem.org/verify", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
...
async function GetPhone() {
  ...
  let Response = await fetch("https://api.weathersystem.org/getphonenumber", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
  ...
  if (await VerifyServer(Username, Token)) {
    if (Page == "signin.html") {
      ...
      if (Page == "account.html") {
        ...
        if (Phone != null) {
          FixedPhone = `${Phone.substring(0, 2)} (${Phone.substring(
            2,
            5
          )})-${Phone.substring(5, 8)}-${Phone.substring(8, 12)}`;
          document.getElementById(
            "PhoneText"
          ).innerText = `Phone Number: ${FixedPhone}`;
...
async function DeleteAccount(Username, Password) {
  let Response = await fetch("https://api.weathersystem.org/deleteaccount", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
...
async function DeletePhoneNumber(Username, Password) {
  ...
  let Response = await fetch(
    "https://api.weathersystem.org/deletephonenumber",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
...
async function AddPhoneNumberUI() {
  ...
  if (TextConsent && StoreConsent) {
    ...
    ErrorText.innerText =
      "You must consent to both items listed above to continue.";
  }
}
...
async function SetLocation(State, County) {
  let Response = await fetch("https://api.weathersystem.org/setLocation", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
...
async function VerifyPhone() {
  let Response = await fetch(
    "https://api.weathersystem.org/verifyPhoneNumber",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
